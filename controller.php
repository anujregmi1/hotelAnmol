...
<body>
	...
	<form action="controller.php" method="POST">
		...
		Coupon Code: <input type="text" name="couponCode" disabled=true id="coupon" onclick="enableTextField()"><br><br>
		VIPID: <input type="text" name="vipId" disabled=true id="vipid"><br><br>
